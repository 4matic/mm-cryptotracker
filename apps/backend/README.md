...
- [CryptoTracker Backend](#cryptotracker-backend)
  ...
  - [API Reference](#api-reference)
    - [REST API Endpoints](#rest-api-endpoints)
      - [Assets (`/api/assets`)](#assets-apiassets)
      - [Trading Pairs (`/api/trading-pairs`)](#trading-pairs-apitrading-pairs)
      - [Data Providers (`/api/data-providers`)](#data-providers-apidata-providers)
      - [Price History (`/api/price-history`)](#price-history-apiprice-history)
      - [Price Fetching (`/api/price-fetching`)](#price-fetching-apiprice-fetching)
...
ASSETS_PUBLIC_URL=http://localhost:4000/assets              # For asset logos in seeders
